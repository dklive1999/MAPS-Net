...
from models.maps_net import get_maps
...
def parse_args():
    ...
    parser.add_argument("--run_name", type=str, default="MAPS-Net", help="run name")
    ...
    ## dataset
    parser.add_argument("--paths_file", type=str, default="/root/autodl-tmp/MAPS-Net-main/datasets_txt/Casiav2.txt",
    ...
    parser.add_argument("--workers", type=int, default=1, help="number of cpu threads to use during batch generation")
    ...
    parser.add_argument("--lambda_redge", type=float, default=10, help="redge-scale loss weight (omega)")
    ## log
