...
def get_opt():
    ...
    parser.add_argument("--model_path", type=str, help="Path to the pretrained model", default="/root/autodl-tmp/MAPS-Net-main/checkpoints/None_MAPS-Net/None_70_end.pth")
    parser.add_argument("--test_file", default="/root/autodl-tmp/MAPS-Net-main/Casiav2/val.txt", type=str, help="Path to the image list")
...
if __name__ == '__main__':
    ...
    model = get_maps(backbone='resnet50',
