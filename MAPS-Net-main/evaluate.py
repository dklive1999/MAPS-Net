...
def parse_args():
    ...
    parser.add_argument('--gt_file', type=str, default='/root/autodl-tmp/MAPS-Net-main/Casiav2/val.txt')
    parser.add_argument('--th', type=float, default=0.5)
    parser.add_argument("--model_name", type=str, help="Path to the pretrained model", default="/root/autodl-tmp/MAPS-Net-main/checkpoints/None_MAPS-Net/None_70_end.pth")
